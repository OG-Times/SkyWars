...
public class SkyWars extends JavaPlugin implements Listener {
    ...
    public static boolean is19orHigher() {
        return server_version.contains("v1_9") ||
                server_version.contains("v1_10") ||
                server_version.contains("v1_11") ||
                server_version.contains("v1_12");
    }
    ...
    public static String checkUpdate(String resourceId) {
    ...
    public void onPluginEnable(PluginEnableEvent event) {
        ...
        if (plugin.getName().equals("LeaderHeads")) {
    ...
    public static void ifl_debug() {
        String watermark = "INF1548LEAKS";
    }
}