package fun.ogtimes.skywars.spigot.utils.economy;
...
import fun.ogtimes.skywars.spigot.utils.economy.skyeconomy.VaultUtils;
...
public final class SkyEconomyManager {
    @Getter private static SkyEconomy economy;
