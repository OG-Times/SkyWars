...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    public Cuboid expand(CuboidDirection var1, int var2) {
        return switch (var1) {
            case North -> new Cuboid(this.worldName, this.x1 - var2, this.y1, this.z1, this.x2, this.y2, this.z2);
            case South -> new Cuboid(this.worldName, this.x1, this.y1, this.z1, this.x2 + var2, this.y2, this.z2);
            case East -> new Cuboid(this.worldName, this.x1, this.y1, this.z1 - var2, this.x2, this.y2, this.z2);
            case West -> new Cuboid(this.worldName, this.x1, this.y1, this.z1, this.x2, this.y2, this.z2 + var2);
            case Down -> new Cuboid(this.worldName, this.x1, this.y1 - var2, this.z1, this.x2, this.y2, this.z2);
            case Up -> new Cuboid(this.worldName, this.x1, this.y1, this.z1, this.x2, this.y2 + var2, this.z2);
            default -> throw new IllegalArgumentException("Invalid direction " + var1);
        };
    }

    public Cuboid shift(CuboidDirection var1, int var2) {
        return this.expand(var1, var2).expand(var1.opposite(), -var2);
    }

    public Cuboid outset(CuboidDirection var1, int var2) {
        Cuboid var3 = switch (var1) {
            case Horizontal ->
                    this.expand(CuboidDirection.North, var2).expand(CuboidDirection.South, var2).expand(CuboidDirection.East, var2).expand(CuboidDirection.West, var2);
            case Vertical -> this.expand(CuboidDirection.Down, var2).expand(CuboidDirection.Up, var2);
            case Both -> this.outset(CuboidDirection.Horizontal, var2).outset(CuboidDirection.Vertical, var2);
            default -> throw new IllegalArgumentException("Invalid direction " + var1);
        };
    ...
    public Cuboid inset(CuboidDirection var1, int var2) {
    ...
    public Cuboid contract(CuboidDirection var1) {
        Cuboid var2 = this.getFace(var1.opposite());
        return switch (var1) {
            case North -> {
                while (var2.containsOnly(0) && var2.getLowerX() > this.getLowerX()) {
                    var2 = var2.shift(CuboidDirection.North, 1);
                }

                yield new Cuboid(this.worldName, this.x1, this.y1, this.z1, var2.getUpperX(), this.y2, this.z2);
            }
            case South -> {
                while (var2.containsOnly(0) && var2.getUpperX() < this.getUpperX()) {
                    var2 = var2.shift(CuboidDirection.South, 1);
                }

                yield new Cuboid(this.worldName, var2.getLowerX(), this.y1, this.z1, this.x2, this.y2, this.z2);
            }
            case East -> {
                while (var2.containsOnly(0) && var2.getLowerZ() > this.getLowerZ()) {
                    var2 = var2.shift(CuboidDirection.East, 1);
                }

                yield new Cuboid(this.worldName, this.x1, this.y1, this.z1, this.x2, this.y2, var2.getUpperZ());
            }
            case West -> {
                while (var2.containsOnly(0) && var2.getUpperZ() < this.getUpperZ()) {
                    var2 = var2.shift(CuboidDirection.West, 1);
                }

                yield new Cuboid(this.worldName, this.x1, this.y1, var2.getLowerZ(), this.x2, this.y2, this.z2);
            }
            case Down -> {
                while (var2.containsOnly(0) && var2.getLowerY() > this.getLowerY()) {
                    var2 = var2.shift(CuboidDirection.Down, 1);
                }

                yield new Cuboid(this.worldName, this.x1, this.y1, this.z1, this.x2, var2.getUpperY(), this.z2);
            }
            case Up -> {
                while (var2.containsOnly(0) && var2.getUpperY() < this.getUpperY()) {
                    var2 = var2.shift(CuboidDirection.Up, 1);
                }

                yield new Cuboid(this.worldName, this.x1, var2.getLowerY(), this.z1, this.x2, this.y2, this.z2);
            }
            default -> throw new IllegalArgumentException("Invalid direction " + var1);
        };
    }

    public Cuboid getFace(CuboidDirection var1) {
        return switch (var1) {
